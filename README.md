...
```sh
git clone https://github.com/fabtrb/claude-dashboard.git ~/.claude/dashboard
```
...
```powershell
git clone https://github.com/fabtrb/claude-dashboard.git "$env:USERPROFILE\.claude\dashboard"
